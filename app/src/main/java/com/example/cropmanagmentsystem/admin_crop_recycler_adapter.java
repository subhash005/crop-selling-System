...
//    private void showEditDeleteDialog(crops_model crop) {
...
//        CircleImageView edit_crop_image = dialogView.findViewById(R.id.edit_crop_image);
...
//        btn_edit_update_crop.setOnClickListener(new View.OnClickListener() {
//            @Override
//            public void onClick(View v) {
...
//                }
//
//                // Update Firebase with the new crop values
//                DatabaseReference cropRef = FirebaseDatabase.getInstance().getReference("Crops").child(crop.getCropId());
//                crops_model updatedCrop = new crops_model(crop.getCrop_pic(), name_crop, description_crop, category_crop, organic_crop, stock, price, crop.getCropId());
//
//                cropRef.setValue(updatedCrop)
